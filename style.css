...
const storyTextZh = '外边有35度，于是:inserta:出去遛弯。当走到:insertb:时他被眼前的景象惊呆了，然后就:insertc:。李雷全程目睹但他并没有慌，因为:inserta:是一个270斤的胖子，天气又辣么热。';
const insertA = ['小龙人', '大老爹', '圣诞老人'];
const insertB = ['白宫', '迪士尼乐园','长沙大学'];
